# Build
```
docker build -t chnchenjie/highcharts-export-server-puppeteer .
```

# Run
```
docker run -d -p 7801:7801/tcp \
    --cap-add=SYS_ADMIN \
    --name highcharts-export-server-puppeteer \
    chnchenjie/highcharts-export-server-puppeteer
```
